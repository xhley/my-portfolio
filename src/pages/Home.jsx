function Home() {
  ...
  <div className="hero-image">
    <img src="/my-portfolio/profile.jpg" alt="Ashley" />
  </div>

  <div className="hero-content">
    <p className="hero-script">digital diary of a developer ✿</p>
    ...
    <div className="hero-buttons">
      ...
      <section id="about" className="section soft-card">
        <h2>About Me</h2>
        <p>
      ...
      <section id="contact" className="section soft-card">
        <h2>Contact</h2>
